...
(28, '$2y$10$y2HTqm3GQxZRFl.V0Rt1dOIIpeaOHh62qrdA0w.eeqQLA8JrEJLDK', 'fred', 'trop', 'freddricktropico@gmail.com', NULL, NULL, '2025-05-10 16:01:59');
...
(95, 202210330, 'FREDDRICK', 'TROPICO', 'ic.freddrick.tropico@cvsu.edu.ph', '09515254884', 626, 84, 'Frankenstein; Or, The Modern Prometheus', '2025-05-06', '2025-05-10', 'Borrowed', '2025-05-10 23:29:44'),
(96, 202210330, 'FREDDRICK', 'TROPICO', 'ic.freddrick.tropico@cvsu.edu.ph', '09515254884', 627, 2701, 'Moby Dick; Or, The Whale', '2025-05-07', '2025-05-09', 'Pending', '2025-05-09 17:52:36');
...
(364, 627, 'Moby Dick; Or, The Whale', 'Melville, Herman', 'https://www.gutenberg.org/cache/epub/2701/pg2701.cover.medium.jpg', '2025-05-10 13:55:39', 'EN', '67'),
(365, 629, 'Alice\'s Adventures in Wonderland', 'Carroll, Lewis', 'https://www.gutenberg.org/cache/epub/11/pg11.cover.medium.jpg', '2025-05-10 14:20:45', 'EN', '67');

-- --------------------------------------------------------

--
-- Table structure for table `fines_table`
--

CREATE TABLE `fines_table` (
  `fine_id` int(255) NOT NULL,
  `fine_name` varchar(255) NOT NULL,
  `price` int(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `fines_table`
--

INSERT INTO `fines_table` (`fine_id`, `fine_name`, `price`) VALUES
(1, 'Damaged-Low', 100),
(2, 'Damaged-Medium', 200),
(3, 'Damaged-High', 300);
...
(19, '$2y$10$FjsSKgBIdvIWqAafSLV.mOblSSpnyayA/A3skpxKzUwkxwATTHnTS', 'Fred', 'Tropico', 'freddricktropico14@gmail.com', NULL, NULL, NULL);
...
INSERT INTO `student_fines` (`violation_id`, `student_no`, `book_id`, `fine_id`, `date_issued`, `status`) VALUES
(1, '202210330', 626, 3, '2025-05-10', 'unpaid'),
(2, '202210330', 626, 1, '2025-05-10', 'unpaid'),
(3, '202210330', 626, 2, '2025-05-10', 'unpaid'),
(4, '202210330', 626, 1, '2025-05-10', 'unpaid'),
(5, '202210330', 626, 2, '2025-05-10', 'unpaid');
...
(629, 'https://www.gutenberg.org/cache/epub/11/pg11.cover.medium.jpg', 'Alice\'s Adventures in Wonderland', 'Carroll, Lewis', 'EN', 'Project Gutenberg', '2025-05-07', 11, 'Alice, Children\'s, Fantasy, Imaginary', 28, 'Available'),
...
--
-- Indexes for table `fines_table`
--
ALTER TABLE `fines_table`
...
--
ALTER TABLE `borrowed_books`
  MODIFY `borrow_id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=106;
...
--
ALTER TABLE `collection_books`
  MODIFY `collection_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=366;

--
-- AUTO_INCREMENT for table `fines_table`
--
ALTER TABLE `fines_table`
  MODIFY `fine_id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `student_fines`
  ADD CONSTRAINT `student_fines_ibfk_1` FOREIGN KEY (`fine_id`) REFERENCES `fines_table` (`fine_id`);
